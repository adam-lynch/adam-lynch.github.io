...
I've always wanted to play around with [Contentful](https://www.contentful.com/), a cloud-based headless CMS service. It seems really good, but I ended up choosing a Git-based approach again. Contentful doesn't support Markdown for one. Even though the editor is good, I would have no choice but to use it. I can use whatever I like with Git; a text editor, IDE, [Classeur](http://classeur.io/) (my favourite Markdown editor), etc. 
